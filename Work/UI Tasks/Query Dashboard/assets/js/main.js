...
(function () {
	...
	var ParticleNetwork = function (parent) {
		this.options = {
			...
			netLineDistance: 200,
			netLineColor: '#001A0F',
			particleColors: ['#001A0F'] // ['#6D4E5C', '#aaa', '#FFC458' ]
		};
		this.canvas = parent.canvas;
		this.ctx = parent.ctx;
...
listDot.click(function () {
	var index = $(this).index();
	dindex = index;
	if ($(".active-description").index() == index) {
	}
	else {
		$(".active-description").removeClass("active-description");
		desc[index].classList.add("active-description");
		$(".dot-active").removeClass("dot-active");
		listDot[index].classList.add("dot-active");
	}
});
...
$(document).ready(function onload() {	
	...
	setInterval(function () {	
		...
		$(".active-description").removeClass("active-description");
		desc[dindex].classList.add("active-description");
		$(".dot-active").removeClass("dot-active");
		listDot[dindex].classList.add("dot-active");
		dindex++;
	}, 2000);
});